...
MX.emailService = '//www.gob.mx/subscribe';
MX.trackingID = '';
...
MX.secBuilder = function () {
	...
	'<header>'+
		'<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">'+
            ...
            '<img src="https://framework-gb.cdn.gob.mx/landing/img/logoheader.svg" width="128" height="48" alt="PÃ¡gina de inicio, Gobierno de MÃ©xico">'+
			      // '<img src="' + MX.imagesPath + 'gobmxlogo-3.svg" width="75" height="23" alt="PÃ¡gina de inicio, Gobierno de MÃ©xico">'+
			    '</a>'+
			  '</div>'+
  ...
  '<footer class="main-footer">'+
    '<div class="list-info">'+
      '<div class="container">'+
        '<div class="row">'+
          '<div class="col-sm-3">'+
            '<img data-v-9e928f9a="" src="https://framework-gb.cdn.gob.mx/landing/img/logoheader.svg" href="/" alt="logo gobierno de mÃ©xico" class="logo_footer" style="max-width: 90%;">'+ 
          '</div>'+
          '<div class="col-sm-3">'+
            '<h5>Enlaces</h5>'+
            '<ul>'+
              '<li><a href="https://participa.gob.mx"  rel="noopener" title="Enlace abre en ventana nueva">Participa</a></li>' +
              '<li><a href="https://www.gob.mx/publicaciones"  rel="noopener" title="Enlace abre en ventana nueva">Publicaciones Oficiales</a></li>' +
              '<li><a href="http://www.ordenjuridico.gob.mx"  rel="noopener" title="Enlace abre en ventana nueva">Marco JurÃ­dico</a></li>'+
              '<li><a href="https://consultapublicamx.inai.org.mx/vut-web/"  rel="noopener" title="Enlace abre en ventana nueva">Plataforma Nacional de Transparencia</a></li>'+
            '</ul>'+
          '</div>'+
          '<div class="col-sm-3">'+
            ...
            '<p>Es el portal &uacute;nico de tr&aacute;mites, informaci&oacute;n y participaci&oacute;n ciudadana. <a href="' + MX.gobmxPath + 'que-es-gobmx">Leer m&aacute;s</a></p>'+
              '<ul>'+
                ...
                '<li><a href="' + MX.gobmxPath + 'accesibilidad">DeclaraciÃ³n de accesibilidad</a></li>'+
                ...
                '<li><a href="' + MX.gobmxPath + 'terminos#medidas-seguridad-informacion">PolÃ­tica de seguridad</a></li>'+
                '<li><a href="' + MX.gobmxPath + 'sitemap">Mapa de sitio</a></li>'+
              '</ul>'+
          '</div>'+
          '<div class="col-sm-3">'+
            '<h5><a href="' + MX.gobmxPath + 'tramites/ficha/presentacion-de-quejas-y-denuncias-en-la-sfp/SFP54">Denuncia contra servidores pÃºblicos</a></h5>'+
            '<h5>S&iacute;guenos en</h5>'+
            '<ul class="list-inline">'+
              '<li><a class="social-icon facebook"  rel="noopener" title="Enlace abre en ventana nueva" href="https://www.facebook.com/gobmexico" aria-label="Facebook de presidencia"></a></li>'+
              '<li><a class="social-icon twitter"  rel="noopener" title="Enlace abre en ventana nueva" href="https://twitter.com/GobiernoMX" aria-label="Twitter de presidencia"></a></li>'+
            '</ul>'+
          '</div>'+
        '</div>'+
      '</div>'+
