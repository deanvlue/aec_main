/* jshint esversion: 6 */
const materias = ["PENSAMIENTO MATEMÁTICO", "LENGUAJE Y COMUNICACIÓN", "CUIDADO DE LA SALUD", "CONVIVENCIA SANA Y CIVISMO",];
...
horarios.forEach((h, i) => {
    ...
    agendaActividad.forEach((tslot, it) => {
        ...
        cell.setAttribute("title", "Da click aquí para agregar o cambiar tu tarea");
